...
const Elephant_1 = require("./src/animals/Elephant");
const Lion_1 = require("./src/animals/Lion");
const Nourisseur_1 = require("./src/services/Nourisseur");
const ZooRepository_1 = require("./src/services/ZooRepository");
